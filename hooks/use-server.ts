...
export interface UseServerResult {
  ...
  initSession: (id: string | null, agent?: string | null, repoPath?: string | null, opts?: { resumeLatestForRepo?: boolean }) => void;
  listRepos: () => void;
...
export function useServer(serverUrl: string | null): UseServerResult {
  ...
  const initSess         = useCallback((id: string | null, agent?: string | null, rp?: string | null, opts?: { resumeLatestForRepo?: boolean }) => { if (serverUrl) initSessionStore(serverUrl, id, agent, rp, opts); }, [serverUrl]);
